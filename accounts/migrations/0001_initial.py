# Generated by Django 4.2.7 on 2024-12-09 17:41
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.PositiveBigIntegerField(blank=True, null=True, validators=[accounts.models.validate_phone])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('phone', models.PositiveBigIntegerField(null=True, validators=[accounts.models.validate_phone])),
                ('created_at', models.DateTimeField(auto_now_add=True)),
                ('updated_at', models.DateTimeField(auto_now=True)),
                ('user', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to=settings.AUTH_USER_MODEL)),
            ],
